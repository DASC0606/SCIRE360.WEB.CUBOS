...
SuperClass for Aplication for Control Error Exceptions 
...
namespace Alvisoft.Helpers
{
    public sealed class ExceptionManager
    {
        ...
        public static string DoLogAndGetFriendlyMessageBoxForException ( Exception ex )
            {
            try
                {
                Logger.LogError ( ex );
            ...
            return GetFriendlyMessageBoxForException ( ex );
            }
        ...
        public static string GetFriendlyMessageBoxForException ( Exception ex )
            {
            string message = "Error: There was a problem while processing your request: " + ex.Message;
            ...
            return MessageFormatter.GetFormattedMsgBoxMessage ( message );
            }
    }
}