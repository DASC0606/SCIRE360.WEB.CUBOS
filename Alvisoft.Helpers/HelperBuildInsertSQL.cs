...
namespace Alvisoft.Helpers
    {
    public partial class HelperBuildInsertSQL
        ...
        public static string BuildStringInsertSQL ( DataTable table )
            {
        ...
        public static SqlCommand CreateTSQLInsertCommand ( DataRow row )
            {
            DataTable table = row.Table;
            string sql = BuildStringInsertSQL ( table );
        ...
        public static object InsertDataRow ( DataRow row, string connectionString )
            {
            SqlCommand command = CreateTSQLInsertCommand ( row );
